...
const normalizeBeforeHooks = (hooks = []) => {
...
const normalizeBasePath = (basePath) => !basePath || basePath === "/" ? "" : basePath;
const withConvexSiteBaseURL = (ctx, basePath) => ({
    ...ctx,
    context: {
        ...ctx.context,
...
export const convex = (opts) => {
    ...
    const oauthProvider = oauthProviderPlugin({
        ...
        allowDynamicClientRegistration: oauthProviderOptions.allowDynamicClientRegistration ?? false,
        allowUnauthenticatedClientRegistration: oauthProviderOptions.allowUnauthenticatedClientRegistration ?? false,
    ...
    const { getOpenIdConfig: oauthProviderGetOpenIdConfig, getOAuthServerConfig: oauthProviderGetOAuthServerConfig, ...oauthProviderEndpoints } = oauthProvider.endpoints;
    const getOAuthProviderBasePath = (ctx) => ctx?.context?.options?.basePath ?? opts.options?.basePath ?? "/api/auth";
    const publicOptions = {
    ...
    return {
        ...
        endpoints: {
            ...
            oauthProviderGetOpenIdConfig: createAuthEndpoint("/.well-known/openid-configuration", {
                method: "GET",
                metadata: {
                    isAction: false,
                },
            ...
            oauthProviderGetOAuthServerConfig: createAuthEndpoint("/.well-known/oauth-authorization-server", {
                method: "GET",
                metadata: {
                    isAction: false,
                },
            ...
            getOAuthServerConfig: createAuthEndpoint("/convex/.well-known/oauth-authorization-server", {
                method: "GET",
                metadata: {
                    isAction: false,
                },
            ...
            getRootJwks: createAuthEndpoint("/jwks", {
                method: "GET",
                metadata: {
                    openapi: {
